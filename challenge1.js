...
// challenge10
let EURO = Number(prompt('entré la valeur en euro: '))
let MAD = EURO/10.61
console.log(`votre valeur est ${MAD} dhs`);
//challenge8
let numero1 = String(prompt('entré un numéro à 3 chiffres:"(...)"'))
let numero1 = String(prompt('entré un numero à 3 chiffres: ("...")'))
let arr = numero1.split("")
 arr = arr.reverse()
 arr = arr.join("")
console.log(`${arr}`)
